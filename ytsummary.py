...
def main():
    ...
    parser.add_argument('video_id_or_url', type=str,
                        help='The video id or url of the video to summarize')
    parser.add_argument('--outfile', type=str,
                        help='The name of the file to write the summary to')
    parser.add_argument('--prompt_header', type=str,
                        help='The name of the file to write the prompt header to')
    parser.add_argument('--chunk_len_mins', type=int,
                        help='The length of the chunks to summarize in minutes')
    parser.add_argument('--diagnostics', action='store_true',
                        help='Print out the prompts and responses')
    parser.add_argument('--mentions', action='store_true',
                        help='Include people and entities mentioned in the video')
    parser.add_argument('--save_transcript', type=str,
                        help='The name of the file to write the transcript to')
    ...
    if not outfile_name:
        default_output_file_path_elems = [
            "working", f"yt_transcript_{video_id}.txt"]
    ...
    result = summarize_audio_transcript_chunks(
        chunks, prompt_header, include_mentions, chunk_len_mins)
